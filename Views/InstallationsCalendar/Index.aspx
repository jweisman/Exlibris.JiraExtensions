            ...
            <% for (var i = 0; i < Model.installers.Count; i ++ )
               {
                   ...
                   if (Model.installers[i].openInstallations.Count > 0 || (install.userName == Model.installers[i].userName && (install.startDate <= date && install.endDate >= date) ))
                   {
                       Response.Write("<td class='busy'");
                       Response.Write(Html.NewInstallLink(date, Model.installers[i].userName)+">");
                       ...
                       while (install.startDate <= date && install.userName == Model.installers[i].userName)
                       {
